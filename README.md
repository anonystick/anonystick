...
25 - [MYSQL BACKEND(25): Chiến lược Backup và Phục hồi dữ liệu (Recovery) cho hệ thống High Availability.](https://www.youtube.com/@anonystick/courses)
...
27 - [MYSQL BACKEND(27): Tối ưu hoá câu lệnh truy vấn phức tạp bằng kỹ thuật Common Table Expressions (CTE).](https://www.youtube.com/@anonystick/courses)

28 - [MYSQL BACKEND(28): Bí mật về Buffer Pool và cách MySQL quản lý bộ nhớ đệm để đạt tốc độ tối đa.](https://www.youtube.com/@anonystick/courses)

29 - [MYSQL BACKEND(29): Bảo mật Database - Chống SQL Injection và quản lý phân quyền (RBAC) nâng cao.](https://www.youtube.com/watch?v=wGsYVgNeEAs&t=569s)

30 - [MYSQL BACKEND(30): Cuối cùng thì Creation Pool chính xác, và ResponseTime từ 120ms xuống 4ms!](https://www.youtube.com/watch?v=vjHWkHm4cqo)

31 - [MYSQL BACKEND(31): Performance APIs - Cách sâu sắc để tăng tốc hiệu suất Backend nên triển khai trong dự án](https://www.youtube.com/watch?v=_MtfJwJW7lc)

32 - [MYSQL BACKEND(32): Tổng kết lộ trình: Trở thành chuyên gia MySQL Backend trong hệ thống hàng triệu người dùng.](https://www.youtube.com/@anonystick/courses)
